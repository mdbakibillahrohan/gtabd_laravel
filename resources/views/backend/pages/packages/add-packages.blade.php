...
@section('backend_page_content')
    <div class="container my-5">
        <h3>Add a Package</h3>
        <form enctype="multipart/form-data" action="{{ route('packages.store') }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <input value="{{ old('city_name') }}" type="text" name="city_name" class="form-control" id="city_name"
            ...
            <div class="form-group mb-3">
                ...
                <input value="{{ old('duration') }}" placeholder="Ex: 1, 2, 3" type="number" name="duration"
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" name="featured" type="checkbox" id="featured" value="yes">
                <label class="form-check-label" for="featured">Make This Package Featured</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" name="lightening" type="checkbox" id="lightening" value="yes">
            ...
            <div class="form-group mb-3">
                ...
                <input value="{{ old('valid_from') }}" type="date" name="valid_from" class="form-control"
            ...
            <div class="form-group mb-3">
                ...
                <input value="{{ old('valid_till') }}" type="date" name="valid_till" class="form-control"
            ...
            <div class="form-group mb-3">
                ...
                <input value="{{ old('departs') }}" type="text" name="departs" class="form-control" id="departs"
                    aria-describedby="departs">
                @error('departs')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input value="{{ old('price_single') }}" type="text" name="price_single" class="form-control"
                    id="price_single" aria-describedby="price_single">
                @error('price_single')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input value="{{ old('price_double') }}" type="text" name="price_double" class="form-control"
                    id="price_single" aria-describedby="price_double">
                @error('price_double')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input value="{{ old('price_tripple') }}" type="text" name="price_tripple" class="form-control"
                    id="price_tripple" aria-describedby="price_tripple">
            ...
            <div class="collapse" id="itineary">
                <div class="mb-3">
                    <textarea class="form-control" name="itinerary" id="editor_itineary" rows="3">{{ old('itinerary') }}</textarea>
                    @error('itineary')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="collapse" id="pickupnote">
                <div class="mb-3">
                    <textarea class="form-control" name="pick_up_note" id="editor_pickupnote" rows="3">{{ old('pick_up_note') }}</textarea>
                    @error('pick_up_note')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="collapse" id="cancellation">
                <div class="mb-3">
                    <textarea name="cancellation" class="form-control" id="editor_cancellation" rows="3">{{ old('cancellation') }}</textarea>
                    @error('cancellation')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="collapse" id="tax">
                <div class="mb-3">
                    <textarea name="tax_and_rates" class="form-control" id="editor_tax" rows="3">{{ old('tax_and_rates') }}</textarea>
                    @error('tax_and_rates')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="collapse" id="includedservices">
                <div class="mb-3">
                    <textarea name="included_services" class="form-control" id="editor_includedservices" rows="3">{{ old('included_services') }}</textarea>
            ...
            <div class="collapse" id="excludedservices">
                <div class="mb-3">
                    <textarea name="excluded_services" class="form-control" id="editor_exclusiveservices" rows="3">{{ old('excluded_services') }}</textarea>
            ...
            <div class="collapse" id="highlights">
                <div class="mb-3">
                    <textarea name="highlights" class="form-control" id="editor_highlights" rows="3">{{ old('highlights') }}</textarea>
                    @error('highlights')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="collapse" id="generalcondition">
                <div class="mb-3">
                    <textarea name="general_condition" class="form-control" id="editor_generalcondition" rows="3">{{ old('general_condition') }}</textarea>
            ...
            <div class="collapse" id="emisection">
                <div class="mb-3">
                    <textarea name="emi" class="form-control" id="editor_emisection" rows="3">{{ old('emi') }}</textarea>
                    @error('emi')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
